            ...
            <div class="card-body">
                <form action="../../actions/announcement/store.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="announcement_title" name="announcement_title" class="form-control" id="announcement_title_titleInput"
                            placeholder="Masukan judul..." required>
                    </div>

                    <div class="mb-3">
                        <label for="announcement_descriptionInput" class="form-label">Deskripsi Pengumuman</label>
                        <textarea name="announcement_description" id="announcement_descriptionInput" class="form-control"
