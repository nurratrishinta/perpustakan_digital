                ...
                <form action="../../actions/teacher/store.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="teacher_name" name="teacher_name" class="form-control" id="teacher_nameInput"
                            placeholder="Masukan Nama..." required value="<?= $teacher->teacher_name ?>">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="teacher_major" name="teacher_major" class="form-control" id="teacher_majorInput"
                            placeholder="Masukan Jurusan..." required value="<?= $teacher->teacher_major ?>">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="teacher_photo" class="form-control" id="teacher_photo" required>
                    </div>
