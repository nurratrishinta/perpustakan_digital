                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?= $no ?></td>
                                    <td>
                                        <img src="../../../storages/achievements/<?= $item->image ?>" alt="Gambar" width="100"
                                            height="100">
                                    </td>
                                    <td>
                                        <?= mb_strimwidth($item->title, 0, 20, "...") ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <a href="../../actions/achievements/destroy.php?id=<?= $item->id ?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin?')">Hapus</a>
                                    </td>
                                </tr>
                            <?php
                                $no++;
