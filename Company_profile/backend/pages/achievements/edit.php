    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5>Ubah Data Pencapaian</h5>
            </div>
            <div class="card-body">
                <?php
                include '../../actions/achievements/show.php';
                ?>
                <form action="../../actions/achievements/update.php?id=<?= $achievements->id ?>" method="POST" enctype="multipart/form-data">


                    <div class="mb-3">
                        <label for="titleInput" class="form-label">Judul</label>
                        <input type="text" name="title" class="form-control" id="titleInput"
                            placeholder="Masukan judul..." required value="<?= $achievements->title ?>">
                    </div>

                    <div class="mb-3">
                        <label for="descriptionInput" class="form-label">Deskripsi</label>
                        <textarea name="description" id="descriptionInput" class="form-control"
                            placeholder="Masukan Deskripsi ..." rows="5"></textarea  required value="<?= $achievements->description ?>">
                    </div>
