        ...
        <div class="container-fluid py-1 px-3 d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center gap-4">
                ...
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="navbarDropdown" style="min-width: 200px;">
                        <li class="px-3 py-2 text-center">
                            <strong><?= $_SESSION['user_name'] ?? 'Shinta' ?></strong><br>
                            <small class="text-muted"><?= $_SESSION['user_email'] ?? 'shintaaa@gmail.com' ?></small>
                        </li>
                        <li>
